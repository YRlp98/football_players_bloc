...
import 'package:football_players_bloc/bloc/player_listing_event.dart';
...
class PlayerListingBloc extends Bloc<PlayerListingEvent, PlayerListingState> {
  ...
  @override
  Stream<PlayerListingState> transformEvents(Stream<PlayerListingEvent> events,
      Stream<PlayerListingState> Function(PlayerListingEvent event) next) {
    // TODO: implement transformEvents
    return super.transformEvents(
      (events as Observable<PlayerListingEvent>)
